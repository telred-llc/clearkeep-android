...
class DirectMessageShareFileFragmentViewModel @Inject constructor(roomRepository: RoomRepository, roomUserJoinRepository: RoomUserJoinRepository) : AbstractDirectMessageShareFileFragmentViewModel() {

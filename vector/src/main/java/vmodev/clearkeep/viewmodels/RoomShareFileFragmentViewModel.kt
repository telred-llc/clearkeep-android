...
class RoomShareFileFragmentViewModel @Inject constructor(roomRepository: RoomRepository, roomUserJoinRepository: RoomUserJoinRepository) : AbstractRoomShareFileFragmentViewModel() {

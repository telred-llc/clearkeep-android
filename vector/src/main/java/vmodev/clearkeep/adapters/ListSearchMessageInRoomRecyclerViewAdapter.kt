...
import im.vector.databinding.ItemMessageSearchInRoomBinding
import im.vector.extensions.getColorFromAttr


class ListSearchMessageInRoomRecyclerViewAdapter constructor(appExecutors: AppExecutors,
    ...
    : ListAdapter<MessageRoomUser, DataBoundViewHolder<ItemMessageSearchInRoomBinding>>(AsyncDifferConfig.Builder(diffCallback)
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): DataBoundViewHolder<ItemMessageSearchInRoomBinding> {
        val binding = DataBindingUtil.inflate<ItemMessageSearchInRoomBinding>(LayoutInflater.from(p0.context),
                R.layout.item_message_search_in_room, p0, false, dataBindingComponent.getDataBindingComponent());
    ...
    override fun onBindViewHolder(p0: DataBoundViewHolder<ItemMessageSearchInRoomBinding>, p1: Int) {

...
open class BaseMessageListFragment : MatrixMessageListFragment<VectorMessagesAdapter>(), IMessagesAdapterActionsListener {
                ...
                override fun onSuccess(file: File?) {
                    ...
                    if (menuAction == ACTION_VECTOR_SAVE || menuAction == ACTION_VECTOR_OPEN) {
                        if (checkPermissions(PERMISSIONS_FOR_WRITING_FILES,
                                        this@BaseMessageListFragment, PERMISSION_REQUEST_CODE)) {
    ...
    companion object {
        ...
        fun newInstance(matrixId: String, roomId: String, eventId: String, previewMode: String, layoutResId: Int): BaseMessageListFragment {
            val f = BaseMessageListFragment()

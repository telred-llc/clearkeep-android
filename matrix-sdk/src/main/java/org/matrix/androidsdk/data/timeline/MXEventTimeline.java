...
class MXEventTimeline implements EventTimeline {
    ...
    private void manageBackEvents(int maxEventCount, final ApiCallback<Integer> callback) {
        ...
        android.util.Log.d("Snapshot Size", Integer.toString(mSnapshotEvents.size()));
        for (int i = 0; i < count; i++) {
            ...
            Log.d("Event Manage", snapshotedEvent.mEvent.getContentAsJsonObject().toString());
    ...
    private void addPaginationEvents(List<Event> events,
        ...
        for (Event event : events) {
            ...
            android.util.Log.d("Decrypt", "Necessary");
            ...
            protected void onPostExecute(Void args) {
                if (direction == Direction.BACKWARDS) {
                    ...
                    for (Event event : events) {
                        ...
                        android.util.Log.d("Event Post", event.getContentAsJsonObject().toString());
                    }

...
public class ExportEncryptionTest {
    ...
    public void checkExportError1() {
        ...
        try {
            MXMegolmExportEncryption.decryptMegolmKeyFile(input.getBytes(StandardCharsets.UTF_8), password);
        } catch (Exception e) {
            failed = true;
        }
    ...
    public void checkExportDecrypt1() {
        ...
        try {
            decodedString = MXMegolmExportEncryption.decryptMegolmKeyFile(input.getBytes(StandardCharsets.UTF_8), password);
        } catch (Exception e) {
